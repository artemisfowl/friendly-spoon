...
class MainWindow(QMainWindow):
	...
	def __init__(self, *args, **kwargs):
		...
		nt_btn = QAction("Open in new tab", self)
		nt_btn.setStatusTip("Open in new tab")
		nt_btn.triggered.connect(self.open_in_new_tab)
		navtb.addAction(nt_btn)

		new_btn = QAction("New tab", self)
		new_btn.setStatusTip("Open a new tab")
		new_btn.triggered.connect(self.open_new_tab)
		...
		self.setWindowTitle("sb's browser")
	...
	def open_in_new_tab(self):
		...
		self.add_new_tab(qurl=QUrl(clipboard.text()))
